...
from ..utils.pos_embed import get_abs_pos_non_square, get_abs_pos, get_2d_sincos_pos_embed
...
class VisualTokenizer(nn.Module):
    ...
    def forward(self, image):
        ...
        for ms_feat in multiscale_features:
            pos_embed = get_abs_pos_non_square(
        ...
        H = image_embed.size(1) // self.grid_size
        W = self.grid_size
        pos_embed = get_abs_pos_non_square(self.pos_embed, H, W, cls_token=True)
