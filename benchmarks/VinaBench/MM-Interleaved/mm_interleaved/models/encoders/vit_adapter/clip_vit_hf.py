...
class CLIPVisionEmbeddings(nn.Module):
    ...
    def interpolate_pos_embed(self, image_size, hw_ratio=1.0):
        if image_size == self.image_size and hw_ratio == 1.0:
            return
        
        other_size = int(image_size*hw_ratio)
        new_grid_h = other_size // self.patch_size
        new_grid_w = image_size // self.patch_size
        # num_patches = (image_size // self.patch_size) ** 2
        num_patches = new_grid_h * new_grid_w
